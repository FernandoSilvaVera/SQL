...
CREATE TABLE `animes` (
  ...
  `animeYT` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `genre_animes` (
  ...
  KEY `genre_animes_genre_foreign` (`genre`),
  CONSTRAINT `genre_animes_anime_foreign` FOREIGN KEY (`anime`) REFERENCES `animes` (`anime`),
  CONSTRAINT `genre_animes_genre_foreign` FOREIGN KEY (`genre`) REFERENCES `genres` (`genre`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
